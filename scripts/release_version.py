...
def generate_release_notes(
    ...
    lines.extend([
        ...
        "Deploy PRAVAH to any Kubernetes cluster via our official Helm 3 OCI chart or attached archive:",
        "",
        "```bash",
        f"# Pull and install Helm chart from GHCR OCI Registry",
        f"helm upgrade --install pravah oci://ghcr.io/{repo_name.split('/')[0]}/charts/pravah \\",
        f"  --version {version} \\",
